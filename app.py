...
st.image("https://cricketaddictor.gumlet.io/wp-content/uploads/2021/08/ICC-T20-World-Cup-2021.jpg?compress=true&quality=80&w=800&dpr=2.6")
...
cities = ['Colombo','Mirpur','Johannesburg','Dubai','Auckland','Cape Town','London','Pallekele','Barbados','Sydney','Melbourne',
          ...
          'Southampton','Mount Maunganui','Chittagong','Kolkata','Lahore','Delhi','Nagpur','Chandigarh','Adelaide','Bangalore','St Kitts',
